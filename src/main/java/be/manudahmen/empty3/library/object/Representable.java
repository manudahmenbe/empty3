...
import be.manudahmen.empty3.library.lighting.Intersection;
import be.manudahmen.empty3.library.raytracer.RtIntersectInfo;
import be.manudahmen.empty3.library.raytracer.RtMatiere;
import be.manudahmen.empty3.library.raytracer.RtRay;
