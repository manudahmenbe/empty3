...
package be.manudahmen.empty3.library.tests.rotation;
...
public class TestRotationsObjets extends TestObjetSub {
    ...
    public Matrix33 rotation(int axe) {
        ...
        label = "La be.manudahmen.empty3.library.tests.rotation autour de l'axe des " + (axe == 0 ? "X" : (axe == 1 ? "Y" : (axe == 2 ? "Z" : "AUCUN AXE CONNU"))) + " est effectuée à hauteur de " +
