package be.manudahmen.emptycanvas.library.stl_loader;
 ...
 *          <p>
 *          STL FILE PARSER: Extends StreamTokenizer For Ascii files Each token returned
 *          is checked in StlFile.java Format of an ASCII STL file:
 *          <p>
 *          solid /users/vis/dru/wedge.stl facet normal -1 0 0 outer loop vertex 0.005 1
 *          0 vertex 0 0.543 0 vertex 0.453 1 1 endloop endfacet . . . endsolid
 *          /users/vis/dru/wedge.stl
 *          <p>
 *          That Class is necessary because scientific numbers are not correctly readed
 *          by Tokenizer we must then extend that class and define another getNumber
