...
public class VideoTexture extends ITexture {
    ...
    public Color couleur(double rx, double ry) {
        be.manudahmen.emptycanvas.library.empty3.library.tribase.Point p = getCoord(rx, ry);
    ...
    public Color getMaillageTRIColor(int numQuadX, int numQuadY, double x,
        ...
        be.manudahmen.emptycanvas.library.empty3.library.tribase.Point p = getCoord(xi, yi);
        xi = (int) p.x;
        yi = (int) p.y;
