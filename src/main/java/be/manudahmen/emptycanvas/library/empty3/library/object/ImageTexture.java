...
public class ImageTexture extends ITexture {
    ...
    public int getColorAt(double x, double y) {
        be.manudahmen.emptycanvas.library.empty3.library.tribase.Point trans = getCoord(x, y);
    ...
    public Color getMaillageTexturedColor(int numQuadX, int numQuadY, double x,
                                          double y) {
        be.manudahmen.emptycanvas.library.empty3.library.tribase.Point p = getCoord(x, y);
    ...
    public Color getMaillageTRIColor(int numQuadX, int numQuadY, double x,
        ...
        be.manudahmen.emptycanvas.library.empty3.library.tribase.Point p = getCoord(xi / (double) image.getWidth(), yi / (double) image.getHeight());
