...
import be.manudahmen.emptycanvas.library.empty3.library.tribase.equationeditor.AnalyseurEquationJep;
import be.manudahmen.emptycanvas.library.empty3.library.tribase.equationeditor.TRIObjetSurfaceEquationParametrique;
...
public final class ShowTestResult extends javax.swing.JFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        jCheckBoxOGL.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/be/manudahmen/emptycanvas/library/empty3/library/testing/RESULT_SUCCESS.jpg"))); // NOI18N
        ...
        jCheckBoxModeles.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/be/manudahmen/emptycanvas/library/empty3/library/testing/RESULT_SUCCESS.jpg"))); // NOI18N
        ...
        jCheckBoxFilmRec.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/be/manudahmen/emptycanvas/library/empty3/library/testing/RESULT_SUCCESS.jpg"))); // NOI18N
        ...
        jCheckBoxImagesRec.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/be/manudahmen/emptycanvas/library/empty3/library/testing/RESULT_SUCCESS.jpg"))); // NOI18N
