...
import be.manudahmen.emptycanvas.library.empty3.library.lighting.Intersection;
import be.manudahmen.emptycanvas.library.empty3.library.raytracer.RtIntersectInfo;
import be.manudahmen.emptycanvas.library.empty3.library.raytracer.RtMatiere;
import be.manudahmen.emptycanvas.library.empty3.library.raytracer.RtRay;
